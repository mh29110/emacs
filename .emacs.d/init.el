...
;;my customize config
(setq user-full-name "leejia")
(setq user-mail-address "mh29110@163.com")
(setq mail-sources
'((pop :server "pop3.163.com" ;; 在这里设置pop3服务器
:user "mh29110" ;; 用户名
:port "110"
:password "lizeyu201265"))) ;; 密码
(setq gnus-secondary-select-methods '((nnfolder "")))

(setq user-full-name "leejia") ;; 外发的邮件采用这个名字
(setq user-mail-address "mh29110@163.com") ;;外发的邮件采用这个地址
...
(custom-set-variables
 ...
 '(browse-url-generic-program "C:\\Users\\pc\\AppData\\Local\\Google\\Chrome\\Application\\chrome.exe")
